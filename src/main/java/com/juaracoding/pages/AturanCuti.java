...
public class AturanCuti {
  ...
  private WebElement errorTanggalBatasSisaCuti;

  public WebElement inputTglBatasSisaCuti() {
    return TanggalBatasSisaCuti;
  }

  public WebElement errorTglBatasSisaCuti() {
    return errorTanggalBatasSisaCuti;
  }
